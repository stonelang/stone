...
using DiagnosticOrStoredDiagnotic =
...
protected:
  virtual void EmitDiagnosticMessage(FullSrcLoc Loc, PresumedLoc PLoc,
                                     ...
                                     DiagnosticOrStoredDiagnotic Info) = 0;

  virtual void EmitDiagnosticLoc(FullSrcLoc Loc, PresumedLoc PLoc,
                                 DiagnosticLevel Level,
                                 ArrayRef<CharSrcRange> Ranges) = 0;

  virtual void BeginDiagnostic(DiagnosticOrStoredDiagnotic D,
                               DiagnosticLevel Level) {}

  virtual void EndDiagnostic(DiagnosticOrStoredDiagnotic D,
                             DiagnosticLevel Level) {}

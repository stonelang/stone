#ifndef LLVM_CLANG_UTILS_IDENTIFIERTABLE_H
#define LLVM_CLANG_UTILS_IDENTIFIERTABLE_H
...
public:
  IdentifierTableStats(const IdentifierTable &table, Basic &basic)
      : Stats("identifier table stats:", basic), table(table) {}
  void Print() override;
};

...
//
// This source file is part of the stone.org open source project
//
// Copyright (c) 2021 Apple Inc. and the stone project authors
// Licensed under Apache License v2.0 with Runtime Library Exception
//
// See https://stone.org/LICENSE.txt for license information
// See https://stone.org/CONTRIBUTORS.txt for the list of stone project authors
//
//===----------------------------------------------------------------------===//
//
// An implementation of a stable hashing for stone.
//
// Derived from the reference implementation for SipHash 2-4:
//   https://github.com/veorq/SipHash
//
// With inline buffering derived from the hash implementation in the stone
// Standard Library.
//
//===----------------------------------------------------------------------===//

#ifndef STONE_BASIC_STABLEHASHER_H
#define STONE_BASIC_STABLEHASHER_H
...
/// \c stone::StableHasher::Combiner<T>
///
///    template <typename T>
///    struct stone::StableHasher::Combiner<std::optional<T>> {
///      static void combine(StableHasher &hasher, const std::optional<T> &O) {
///        if (!O.has_value()) {
///          hasher.combine(0);
///        } else {
///          hasher.combine(1);
///          stone::StableHasher::Combiner<T>::combine(hasher, O.value());
///        }
///      }
///    };
///
...
#endif // stone_BASIC_STABLEHASHER_H

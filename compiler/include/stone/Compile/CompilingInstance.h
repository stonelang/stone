#ifndef STONE_COMPILE_COMPILINGINSTANCE_H
#define STONE_COMPILE_COMPILINGINSTANCE_H
...
class alignas(8) CompilingInstance final {
  ...
  //   /// imported by client source code. The swiftmodule format is described
  //   in
  ...
  //   /// It is valid whenever there are any inputs.
  //   ///
  //   /// This binary format stores source locations and other information
  //   about the
  ...
  //   /// It is valid whenever there are any inputs.
  //   ///
  //   /// This binary format stores doc comments and other information about
  //   the
  //   /// declarations in a module.
  //   ///
  //   /// \sa swift::serialize
  ...
  //   /// well-suited to model fine-grained dependencies. See docs/Driver.md
  //   for
  //   /// more information.
  //   ///
  ...
  // public:
  //   CompilingInstance(const unsigned srcID, const file::File &input)
  ...
  //                      unsigned alignment = alignof(CompilingInstance));

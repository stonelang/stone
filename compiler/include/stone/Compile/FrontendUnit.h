...
//   /// It is valid whenever there are any inputs.
//   ///
//   /// This binary format stores source locations and other information about
//   the
...
// void *operator new(size_t bytes, const stone::CompilerInvocation &invocation,
//                    size_t alignment = 8);
...
//                        const stone::CompilerInvocation &invocation, size_t);

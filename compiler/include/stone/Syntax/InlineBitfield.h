...
#ifndef STONE_INLINE_BITFIELD_H
#define STONE_INLINE_BITFIELD_H
...
/// STONE_INLINE_BITFIELD(Foo, Bar, 1+3+7+2, w:1, x:3, y:7, z:2);
...
//     uint64_t : Num##U##Bits, __VA_ARGS__; \
//   } T; \
//   LLVM_PACKED_END \ static_assert(sizeof(T##Bitfield) <= 8, "Bitfield
//   overflow")

// /// Define an empty bitfield for type 'T'.
// #define STONE_INLINE_BITFIELD_EMPTY(T, U) \

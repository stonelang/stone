...
static FunDecl *MakeFunDecl(DeclCollector &collector, SyntaxContext &sc,
                     DeclContext *parent);
static FunDecl *MakeFunDeclImplicit(DeclCollector &collector, SyntaxContext &sc,
                             DeclContext *parent);

static StructDecl *MakeStructDecl(DeclName name, SrcLoc loc, SyntaxContext &sc,
                     DeclContext *parent = nullptr);

static InterfaceDecl *MakeInterfaceDecl(DeclName name, SrcLoc loc, SyntaxContext &sc,
                     DeclContext *parent = nullptr);

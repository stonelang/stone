...
//   auto level =
//       (compilation.GetDriver().CanLink()) ? IntentLevel::Dep :
//       IntentLevel::Top;
...
//   // bcs.current = compilation.CreateIntent<CompileIntent>(intent,
//   isTopLevel);
...
// static void BuildLinkIntent(Compilation &compilation, CompilationHotInfo
// &chi,
//                             Intent *intent) {

...
void stone::EmitDiagnosticDefs(RecordKeeper &Records, raw_ostream &OS,
...
void stone::EmitDiagnosticGroups(RecordKeeper &Records, raw_ostream &OS) {
...
void stone::EmitDiagnosticIndexName(RecordKeeper &Records, raw_ostream &OS) {
  const std::vector<Record *> &Diags =
      Records.getAllDerivedDefinitions("Diagnostic");
...
void stone::EmitDiagnosticDocs(RecordKeeper &Records, raw_ostream &OS) {
